...
2) python train_task.py seed=42 task=VSS task.env.has_initial_ball_vel=False experiment=ddpg-cma-noInitBallVel;;
...
6) python train_task.py seed=43 task=VSS task.env.has_initial_ball_vel=False experiment=ddpg-cma-noInitBallVel;;
...
10) python train_task.py seed=44 task=VSS task.env.has_initial_ball_vel=False experiment=ddpg-cma-noInitBallVel;;
