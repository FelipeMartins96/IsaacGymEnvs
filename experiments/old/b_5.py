...
wall_height = 0.05
# Laterais campo
walls['field_side'] = gym.create_box(sim, 1.50, wall_thickness, wall_height, wall_options)

# Laterais gol
walls['goal_sides'] = gym.create_box(sim, 0.10 + wall_thickness, wall_thickness, wall_height, wall_options)

# Fundos campo
walls['field_ends'] = gym.create_box(sim, wall_thickness, 0.45, wall_height, wall_options)

# Fundos gol
walls['goal_ends'] = gym.create_box(sim, wall_thickness, 0.40, wall_height, wall_options)
...
for i in range(num_envs):
    ...
    # add walls
    wall_handles.append(gym.create_actor(env, walls['field_side'], gymapi.Transform(p=gymapi.Vec3(0.0,0.65 + wall_thickness / 2,0.025)), 'top_wall', group=i, filter=0))
    wall_handles.append(gym.create_actor(env, walls['field_side'], gymapi.Transform(p=gymapi.Vec3(0.0,-(0.65 + wall_thickness / 2),0.025)), 'bottom_wall', group=i, filter=0))

    wall_handles.append(gym.create_actor(env, walls['goal_sides'] , gymapi.Transform(p=gymapi.Vec3((0.8 + + wall_thickness/2),(0.2 + wall_thickness/2),0.025)), 'right_goal_top_side', group=i, filter=0))
    wall_handles.append(gym.create_actor(env, walls['goal_sides'] , gymapi.Transform(p=gymapi.Vec3((0.8 + + wall_thickness/2),-(0.2 + wall_thickness/2),0.025)), 'right_goal_bot_side', group=i, filter=0))
    wall_handles.append(gym.create_actor(env, walls['goal_sides'] , gymapi.Transform(p=gymapi.Vec3(-(0.8 + + wall_thickness/2),(0.2 + wall_thickness/2),0.025)), 'left_goal_top_side', group=i, filter=0))
    wall_handles.append(gym.create_actor(env, walls['goal_sides'] , gymapi.Transform(p=gymapi.Vec3(-(0.8 + + wall_thickness/2),-(0.2 + wall_thickness/2),0.025)), 'left_goal_bot_side', group=i, filter=0))

    wall_handles.append(gym.create_actor(env, walls['field_ends'] , gymapi.Transform(p=gymapi.Vec3((0.75 + + wall_thickness/2),0.45,0.025)), 'right_field_top', group=i, filter=0))
    wall_handles.append(gym.create_actor(env, walls['field_ends'] , gymapi.Transform(p=gymapi.Vec3((0.75 + + wall_thickness/2),-0.45,0.025)), 'right_field_bot', group=i, filter=0))
    wall_handles.append(gym.create_actor(env, walls['field_ends'] , gymapi.Transform(p=gymapi.Vec3(-(0.75 + + wall_thickness/2),0.45,0.025)), 'left_field_top', group=i, filter=0))
    wall_handles.append(gym.create_actor(env, walls['field_ends'] , gymapi.Transform(p=gymapi.Vec3(-(0.75 + + wall_thickness/2),-0.45,0.025)), 'left_field_bot', group=i, filter=0))

    wall_handles.append(gym.create_actor(env, walls['goal_ends'] , gymapi.Transform(p=gymapi.Vec3((0.85 + wall_thickness/2),0.,0.025)), 'right_goal_end', group=i, filter=0))
    wall_handles.append(gym.create_actor(env, walls['goal_ends'] , gymapi.Transform(p=gymapi.Vec3(-(0.85 + wall_thickness/2),0.,0.025)), 'left_goal_end', group=i, filter=0))
...
lw_handle = gym.find_actor_dof_handle(env, actor_handle, 'left_wheel_axis')
rw_handle = gym.find_actor_dof_handle(env, actor_handle, 'right_wheel_axis')
