...
2) python train.py task=VSS seed=42 task.env.has_initial_ball_vel=False experiment=ppo-cma-noInitBallVel-noEnergy;;
...
6) python train.py task=VSS seed=43 task.env.has_initial_ball_vel=False experiment=ppo-cma-noInitBallVel-noEnergy;;
...
10) python train.py task=VSS seed=44 task.env.has_initial_ball_vel=False experiment=ppo-cma-noInitBallVel-noEnergy;;
