...
5) python train.py task=VSS seed=40 task.env.n_controlled_robots=3 experiment=ppo-cma;;
6) python train.py task=VSS seed=41 task.env.n_controlled_robots=3 experiment=ppo-cma;;
7) python train.py task=VSS seed=42 task.env.n_controlled_robots=3 experiment=ppo-cma;;
8) python train.py task=VSS seed=43 task.env.n_controlled_robots=3 experiment=ppo-cma;;
9) python train.py task=VSS seed=44 task.env.n_controlled_robots=3 experiment=ppo-cma;;
